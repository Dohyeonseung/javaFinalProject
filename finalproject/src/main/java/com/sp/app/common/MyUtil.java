...
public class MyUtil {
	...
	public String paging(int current_page, int total_page, String list_url) {
		...
		sb.append("#paginate a {border:1px solid #ccc;height:28px;color:#1e1e1e;text-decoration:none;padding:4px 7px 4px 7px;margin-left:3px;line-height:normal;vertical-align:middle;outline:none; select-dummy: expression(this.hideFocus=true);}");
		sb.append("#paginate a:hover, a:active {vertical-align:middle; line-height:normal;}");
		sb.append("#paginate .curBox {border:none; border-radius:50px; background: #fff; color:#cb3536;  font-weight:bold;height:28px;padding:4px 7px 4px 7px;margin-left:1px;line-height:normal;vertical-align:middle;}");
		sb.append("#paginate .numBox {border:none;border-radius:50px;background:#fff;height:28px;font-weight:bold;text-decoration:none;padding:4px 7px 4px 7px;margin-left:1px;line-height:normal;vertical-align:middle;}");
		sb.append("</style>");
    ...
    public String pagingMethod(int current_page, int total_page, String methodName) {
		...
		sb.append("#paginate a:hover, a:active {border:none; background:#e5e5e5; color:white;vertical-align:middle; line-height:normal;}");
		sb.append("#paginate .curBox {border:none; border-radius:50px; background: #fff; color:#cb3536;  font-weight:bold;height:28px;padding:4px 7px 4px 7px;margin-left:1px;line-height:normal;vertical-align:middle;}");
		sb.append("#paginate .numBox {border:none;border-radius:50px;background:#fff;height:28px;font-weight:bold;text-decoration:none;padding:4px 7px 4px 7px;margin-left:1px;line-height:normal;vertical-align:middle;}");
		sb.append("</style>");

...
<div id="categori">
	<div id="categori_box">
            <a href="${pageContext.request.contextPath}">홈</a> > <span>회사소개</span> > <span>윤리규정</span>
	</div>
</div>
